...
const processBatch = async (batch, batchIdx) => {
    ...
    return {
        ...
        stickers: batch.map(s => ({ fileName: s.fileName, mimetype: s.mimetype, isAnimated: s.isAnimated, emojis: s.emojis, accessibilityLabel: s.accessibilityLabel, name: s.name })),
