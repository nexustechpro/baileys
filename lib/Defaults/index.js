...
// Batch storage limits for Signal, LID mapping, and memory management
export const BATCH_SIZE_SESSION = 1000; // Maximum sessions to keep in memory
export const BATCH_SIZE_SENDER_KEY = 500; // Maximum sender keys to keep in memory
export const BATCH_SIZE_LID_MAPPING = 500; // Maximum LID-PN mappings to keep in memory
export const BATCH_SIZE_SENDER_KEY_MEMORY = 500; // Maximum sender key memory entries to keep in memory
export const BATCH_SIZE_DEVICE_LIST = 500; // Maximum device list entries to keep in memory
