...
export const makeSocket = (config) => {
    ...
    ws.on('error', (error) => {
        logger.error({ err: error }, 'websocket error, attempting reconnect');
        attemptReconnect();
    });
    ws.on('close', () => {
        logger.warn('websocket closed unexpectedly, attempting reconnect');
        attemptReconnect();
    });
    ...
    const attemptReconnect = () => {
        ...
        logger.info({ attempt: reconnectAttempts, backoffMs }, 'Reconnecting websocket...');
